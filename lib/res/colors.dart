...
class Colours {
  ...
  static const Color bg_color = Color(0xFF1C1C1E);
  ...
  static const Color flash_timer_bg_color = Color(0x66000000);

  static const Color tv_login_color = Color(0xFF333333);
  static const Color tv_login_hint_color = Color(0xFFCCCCCC);
  static const Color blue_normal_color = Color(0xFF5bb8ff);
  static const Color blue_time_color = Color(0xFFaddbff);
  static const Color column_bg = Color(0xFFf2f9ff);
  static const Color time_picker_color = Color(0xFF4b89b0);

  static const Color forget_psd_color = Color(0xFF007AFF);

  static const Color login_input_bg_color = Color(0xFF3A3A3C);

  static const Color map_search_bg_color = Color(0xFF2C2C2E);

  static const Color map_search_input_color = Color(0xFF38383A);
}
